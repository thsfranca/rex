...
- [R082c] T:Drop REX_ALLOW_CWD_WORKSPACE + schema sync | S:DOING | P:R082 | N:Y | V:4 | C:2 | D:R082b | Tr:chore/r082-schema-sync | E:JSON-only harness; promote agent-only keys
