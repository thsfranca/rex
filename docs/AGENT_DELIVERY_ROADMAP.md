...
**Current focus:** TUI design system **R080–R081** re-implementation to product bar. LangFuse (**RC-LF1**) unblocked for discovery scheduling.
...
| **R080** | TUI presentation (layout + tokens) | Should | R082 | **Open** |
| **R081** | TUI motion (choreography) | Should | R080 | **Open** |
