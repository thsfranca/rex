...
- **Follow-up:** Daemon OTel wiring; catalog in [OBSERVABILITY_INTEGRATIONS.md](../../historical/OBSERVABILITY_INTEGRATIONS.md).
...
- [OBSERVABILITY_AND_ECONOMICS.md](../../historical/OBSERVABILITY_AND_ECONOMICS.md)
