...
**Current focus:** TUI design system **R080–R081** re-implementation to product bar ([TUI_DESIGN.md](TUI_DESIGN.md), [CLI_OPERATOR_UX.md](CLI_OPERATOR_UX.md)); [PRIORITIZATION.md — Current focus queue](PRIORITIZATION.md#current-focus-queue-audit-2026-07-01).
...
| 5 | **R080** — TUI presentation (layout + tokens) | **Should** | — | [TUI_DESIGN.md](TUI_DESIGN.md) | **Open** |
| 6 | **R081** — TUI motion (choreography) | **Should** | — | [TUI_DESIGN.md](TUI_DESIGN.md) | **Open** |
...
| **Should** | **R080** — TUI presentation (layout + tokens) | [TUI_DESIGN.md](TUI_DESIGN.md) | **Open** |
| **Should** | **R081** — TUI motion (choreography) | [TUI_DESIGN.md](TUI_DESIGN.md) | **Open** |
