...
| [ROADMAP.md](ROADMAP.md) | Progress toward v1.0 (**RC-***) + engineering backlog IDs |
...
| Observability suite + economics validation (planned) | [OBSERVABILITY_AND_ECONOMICS.md](OBSERVABILITY_AND_ECONOMICS.md) |
