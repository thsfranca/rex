...
| Multi-provider inference (LiteLLM primary, native Anthropic planned) | Product architecture | [ADR 0018](architecture/decisions/0018-gateway-first-multi-provider-inference.md), [ADAPTERS.md](ADAPTERS.md) | 0018 |
