...
| 4c — oMLX local inference | **Done** — managed supervisor + `rex omlx` + opt-in E2E — [OMLX_INFERENCE.md](OMLX_INFERENCE.md), [ADR 0033](architecture/decisions/0033-omlx-managed-local-inference.md) |
