...
- **Product agent (planned):** [`docs/AGENT_DELIVERY_ROADMAP.md`](docs/AGENT_DELIVERY_ROADMAP.md) — `rex-agent`, JSON config (**R015** landed; **R016–R019** follow); unified **`rex`** CLI shipped (**R014**); today uses **`rex-sidecar-stub`**.
