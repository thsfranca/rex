...
```bash
pipx install rex-proxy
# or
uv tool install rex-proxy
```

### Run

Set at least one provider API key and start Rex:
...
Point your AI coding tool's base URL to `http://localhost:8000/v1`.
...
2. Clone and install:
   ```bash
   git clone https://github.com/your-org/rex.git && cd rex
   uv sync
   ```
3. Run:
   ```bash
