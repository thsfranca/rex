...
| File | Purpose |
|------|---------|
| [`error_codes.yaml`](error_codes.yaml) | NDJSON stream `error.code` catalog — keep in sync with [docs/ERROR_HANDLING.md](../../docs/ERROR_HANDLING.md) and `fixtures/stream_events` |
